...
Sipsa_Precios = read_excel( "/home/juan-c/Descargas/Metodologia_CIAT-main//precios_sipsa_fuente/series-historicas-precios-mayoristas-2022.xlsx",sheet = i+4)
...
Sipsa_Abs = read.xlsx("R/Datos/abastecimiento_sipsa_fuente/microdato-abastecimiento-2022.xlsx",sheet = i+1)
...
Mapeo_Precios_Abs = read_excel("R/Datos/mapeo_y_criterios_fuente/mapeo_sipsa_abs_precios.xlsx")

# Mercar(precios mayoristas-precios minoristas)
Mapeo_Mayorista_Minorista = read_excel("R/Datos/mapeo_y_criterios_fuente/mapeo_mayoristas_mercar.xlsx")

# SIPSA-TCAC (Códigos de sipsa a  Composición de Alimentos Colombianos)
Mapeo_Sipsa_TCAC = read_excel("R/Datos/mapeo_y_criterios_fuente/mapeo_tcac.xlsx");colnames(Mapeo_Sipsa_TCAC) = c("Alimento", "Codigo_TCAC")
...
Mapeo_Sipsa_TCAC_GABAS_Grupos = read_excel("R/Datos/composicion_nutricional_fuente/composicion_nutricional_corr.xlsx")
...
Primer_Criterio_Lista_Alimentos = read_excel("R/Datos/mapeo_y_criterios_fuente/lista_alimentos_criterio_1.xlsx")
...
Precios_Minoristas_Mercar = read.xlsx(paste0("R/Datos/precios_minoristas_fuente/mercar_",Mes[i],".xlsx"));colnames(Precios_Minoristas_Mercar) = c("Codigo_mercar", "Descripcion", "Fecha", "Precio", "Unidad")
...
#-----                  -------#
Mapeo_Sipsa_TCAC_Carga_2 = read_excel("R/Datos/composicion_nutricional_fuente/composicion_nutricional_corr.xlsx")
...
Porciones_GABAS = read.xlsx("R/Datos/requerimientos_fuente/Recomendaciones y gramos de intercambios GABAS.xlsx", sheet = 2);colnames(Porciones_GABAS) = c("Cod_TCAC", "Alimentos", "Subgrupo_GABAS", "Energia_100g", "Energia_Int", "Intercambio_g")
