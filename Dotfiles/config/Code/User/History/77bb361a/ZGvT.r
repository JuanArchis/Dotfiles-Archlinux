...
Precios_Minoristas_Mercar = read.xlsx(paste0("/home/juan-c/Descargas/Metodologia_CIAT-main/datos_primarios/precios_minoristas_fuente/mercar_",Abri,".xlsx"));colnames(Precios_Minoristas_Mercar) = c("Codigo_mercar", "Descripcion", "Fecha", "Precio", "Unidad")
...
Prueba=Paquete_foottype_ver_0_0_1$new(Mes_Estudio="Abril")
Prueba$Librerias()
Prueba$Módulos_0_1_2()
